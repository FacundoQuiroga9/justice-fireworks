  ...
  return(
    <footer className='footer'>
      ...
      <div className="footer2">
        ...
        <p className="telefono">(972) 977-5193</p>
        ...
        <div className='social-media-container'>
          ...
          <a className='media-link' href="https://www.instagram.com/hosteriaffarmtaid/?theme=dark" target="_blanck">
            <svg className='media' xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="bi bi-instagram" viewBox="0 0 16 16">
      ...
      <div className="footer1">
        ...
        <p className='direccion'>5159 Interstate 30W, Caddo Mills TX 75135</p>
      </div>
